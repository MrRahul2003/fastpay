...
<body>
    ...
    <nav class="p-2 bg-primary text-white">
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <object data="images/logo.png" width="50" height="50"> </object>
                </a>
                ...
                <div class="text-end">
                    <div class="dropdown text-end">
                        ...
                        <ul class="dropdown-menu text-small" aria-labelledby="dropdownUser1" style="">
                            <li><a class="dropdown-item" href="partials/_login_user_profile.php">Profile</a></li>
                            <li><a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#balancemodal">Balance</a></li>
    ...
    <div class="modal fade" id="balancemodal" tabindex="-1" aria-labelledby="balancemodal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="balancemodal">Available Balance </h5>
